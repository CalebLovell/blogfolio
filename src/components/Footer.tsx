export const Footer = () => {
	return (
		<div className='bg-gray-900'>
			<footer className='max-w-6xl mx-auto flex flex-col items-center bg-brand-secondary'>
					...
					<div className='flex flex-col w-full justify-evenly md:flex-row md:items-center md:justify-between'>
						...
						<div className='flex items-center justify-center mt-4 space-x-6 md:mt-0'>
							<a
								...
								className='rounded-md text-gray-200 hover-brand focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue dark:focus:ring-offset-brand-lightGrey'
								target='_blank'
								rel='noreferrer'
							>
