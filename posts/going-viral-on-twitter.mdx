...
So despite feeling a bit guilty for bothering more important people, I tagged a few LATAM related accounts I enjoy following on Twitter, figuring at least a few of them might appreciate my work, and I could move on with my life knowing I was the only person to appreciate what I spent so much time building.
...
And while I had decided at first just to label all such leaders as "independent", I eventually decided to include a "military" category for such figures, so the map would look a tiny bit more nuanced than before.
...
I didn't want to just paint everything green, because that felt like it would make the map less useful. But I see many people have interpreted that choice (intentional or not) as a way to whitewash the true nature of military governments.
